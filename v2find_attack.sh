...
find_attack()
{
	...
	outfile=${res_path}/${5}
        ...
        find ${target_folder} -name "alert*" \
                ...
                | egrep -v "${escape}" \
	        | sed 's#<date-time>#<table style="table-layout:fixed;width:100%;word-wrap:break-word" border="1"><tr class="datetime" style="background:\#D3D3D3"><td style="width:150px">Alert Time </td><td>#g;
			s#</date-time>#</td></tr>#g;
			s#<alert-msg>#<tr class="msg"><td>Alert Message</td><td> #g;
			s#</alert-msg>#</td></tr>#g;
			s#<ip>#<tr class="ip"><td>Frome IP</td><td> #g;
			s#</ip>#</td></tr>#g;
			s#<request>#<tr class="request"><td>Request </td><td>#g;
			s#</request>#</td></tr>#g;
			s#^--#</table><br/>#g'  > ${outfile}
...
find_attack "-A 1 -B 1" "alert-msg.*org.apache.struts2" "<none-need-escape>" "Java Struts2 Attack" "java_struts2.html"
...
find_attack "-B 4" "<request>GET /.*((\.zip)|(\.tar)|(tar\.gz)|(\.gz)) HTTP" "<remote-name>" "Get WebServer Left file" "fetch_compression.html"
